...
namespace _0x5f_Game_0x2d_logic_0x2d_qt_main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appGame_logic_qt)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appGame_logic_qt))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appGame_logic_qt)() {
    return 1;
}
