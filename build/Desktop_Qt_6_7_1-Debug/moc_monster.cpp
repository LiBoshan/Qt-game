...
Q_CONSTINIT static const uint qt_meta_data_CLASSMonsterENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       5,    0,   37,    2, 0x102,    4 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject Monster::staticMetaObject = { {
    QMetaObject::SuperData::link<GameEntity::staticMetaObject>(),
...
void Monster::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateMonsterPosition((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: { QPointF _r = _t->mposition();
...
void *Monster::qt_metacast(const char *_clname)
{
    ...
    return GameEntity::qt_metacast(_clname);
}

int Monster::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GameEntity::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
